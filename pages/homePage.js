            ...
            <div className='flex justify-between text-center md:mx-20 md:pt-32 pt-28 '>
                ...
                <div className='flex flex-col md:ml-20 mt-10'>
                    <h1 className='font-bold text-7xl text-left mb-5'>
                        ...
                        I am a Software engineer in the field of software development(Full stack) doing both websites and mobile applications.I have got intesive skills on different front-end packages(Reactjs,Angular, .NET) & back-end as well(Python-django, C#) also databases(Postgressql,MySQL ). 
                         tudied in Moringa School plus a lot of self commitments and researches.
                        <b/>
                        I am Currently working on WEB 3.0 knowledge and projects and I welcome you all to work with me to improve Tech industries. 
                        </p>
